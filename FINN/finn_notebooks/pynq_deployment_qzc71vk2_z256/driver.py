...
class FINNAccelDriver():
    def __init__(self, N, bitfile):
        ...
        self.ishape_normal = (N, 256, 256, 3)
        self.oshape_normal = (N, 35, 35, 64)
        self.ishape_folded = (N, 256, 256, 3, 1)
        self.oshape_folded = (N, 19600, 4)
        self.ishape_packed = (N, 256, 256, 3, 1)   # datatype np.uint8
        self.oshape_packed = (N, 19600, 16)  # datatype np.uint8
        # clock frequency
        self.fclk_mhz = 100.0
